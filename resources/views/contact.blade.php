                            ...
                            <div class="row no-gutters">
								...
								<div class="col-md-7 d-flex">
                                    ...
                                    <div class="contact-wrap w-100 p-md-5 p-4">
                                        ...
                                        <form method="POST" id="contactForm" class="contactForm" action('contactus.store')>
                                            @csrf
                                            <div class="row">
												...
												<div class="col-md-12">
													<div class="form-group">
														<textarea name="message" class="form-control" id="message" required cols="30" rows="7" placeholder="Message"></textarea>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
					        	...
					        	<div class="dbox w-100 d-flex align-items-start">
					        		...
					        		<div class="text pl-3">
						            <p><span>{{ 'Address:' }}</span> {{ $contact->companyaddress }}</p>
						          </div>
					          </div>
					        	<div class="dbox w-100 d-flex align-items-center">
					        		...
					        		<div class="text pl-3">
						            <p><span>{{ 'Phone:' }}</span> <a href="{{ $contact->companyphone }}">{{ $contact->companyphone }}</a></p>
						          </div>
					          </div>
					        	<div class="dbox w-100 d-flex align-items-center">
					        		<div class="icon d-flex align-items-center justify-content-center">
					        		...
					        		<div class="text pl-3">
						            <p><span>{{ 'Email:' }}</span> <a href="{{ $contact->companyemail }}">{{ $contact->companyemail }}</a></p>
						          </div>
					          </div>
					        	<div class="dbox w-100 d-flex align-items-center">
					        		<div class="icon d-flex align-items-center justify-content-center">
					        		...
					        		<div class="text pl-3">
						            <p><span>{{ 'Website: ' }}</span> <a href="{{ $contact->companygst }}">{{ $contact->companygst }}</a></p>
						          </div>
					          </div>
				          </div>
                                </div>
